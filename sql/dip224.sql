...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2023 at 02:58 AM
...
(13, 'wqe', 'qwe', 'lowgnar@gmail.com', '123454678', 'm', 24);
...
(10, 3, 'Hensem boi Kien Lose', 'weichenheng22@gmail.com', '14 Nov 202', 10),
(11, 4, 'hello this is fun', 'lowgnar@gmail.com', '14 Nov 202', 13);
...
(81, 'IMG-65527384aadcc7.13734262.jpg', 16),
(82, 'IMG-65527384abad25.61582286.jpg', 16),
(83, 'IMG-65527384ac70e9.80330875.jpg', 16),
(106, 'IMG-65531c4d928261.50402475.jpg', 28),
(107, 'IMG-65531c4d934893.70407281.jpg', 28);
...
(12, 'weichen8277@gmail.com', 16, 25);
...
(28, 'Italy Discovery Tour', 'Embark on a mesmerizing journey through the heart of Italy, where history, art, and culinary delights come together to create an unforgettable experience. Immerse yourself in the rich cultural tapestry of this beautiful country, from iconic landmarks to charming villages. Here is a glimpse of what awaits you on this captivating adventure:', 'Romes Timeless Wonders: Explore the grandeur of the Colosseum, Roman Forum, and the awe-inspiring Vatican City, where centuries of history unfold.\r\n\r\nEnchanting Venetian Canals: Discover the unique charm of Venice as you navigate its intricate network of canals, visit St. Marks Basilica, and enjoy a gondola ride through this romantic city.\r\n\r\nArtistic Treasures in Florence: Immerse yourself in the art and culture of Florence, home to masterpieces like Michelangelos David and the Uffizi Gallery.\r\n\r\nCulinary Delights: Indulge in the flavors of Italy with traditional dishes like pasta, pizza, and gelato. Experience a culinary journey that reflects the countrys rich gastronomic heritage.\r\n', 'Round-trip Airfare to Rome, Italy: Enjoy a comfortable journey to the eternal city, where your Italian adventure begins.\r\n\r\nAccommodation: Stay in handpicked hotels, providing a blend of comfort and local charm throughout your journey.\r\n\r\nGuided Tours: Explore Italy treasures with knowledgeable guides leading you to iconic landmarks and hidden gems.\r\n\r\nDaily Meals: Delight your taste buds with authentic Italian cuisine, from hearty breakfasts to savory dinners in select local restaurants.', 10, 10);
...
(12, '2023-11-17', 3000, 2, '2023-11-14', 8, 10, 3),
(13, '2023-11-17', 30, 3, '2023-11-14', 28, 13, 10);
...
(15, '123123123', 'hensem@gmail.com', 'Lenglui Company', 'License', 'IMG-65527b39b8db03.14476290.jpg', 'PENDING', '13/11/2023'),
(16, '010000', 'weichen8277@gmail.com', 'The best comany', 'License', 'IMG-655320263ceb55.43735288.jpg', 'APPROVE', '14/11/2023');
...
(16, 'weichenheng22@gmail.com', '11111111', 'customer'),
...
(24, 'lowgnar@gmail.com', 'asd123123', 'customer'),
(25, 'weichen8277@gmail.com', '123123123', 'merchant');
...
--
ALTER TABLE `image`
  MODIFY `ImageID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT for table `merchant`
--
ALTER TABLE `merchant`
  MODIFY `MerchantID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
